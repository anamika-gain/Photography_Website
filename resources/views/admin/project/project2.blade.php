        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">project List
                    ...
                    <a href="{{ URL::to('admin/project/addbycategory/' . $category->id) }}" class="btn btn-sm btn-warning"
                        ...
                        <tbody>
                            @foreach ($project as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ URL::to('admin/edit/project/' . $row['id']) }}"
                                            class="btn btn-sm btn-info">edit</a>
                                        <a href="{{ URL::to('admin/delete/project/' . $row['id']) }}"
