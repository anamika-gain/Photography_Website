              ...
              <ul class="menu-box nav-bg-overlay-box">
                  ...
                  <li class="nav-btn-box js-nav-bg-change js-nav-bg-active js-dropdown-open">
                      ...
                      <div class="nav-bg-box">
                          <div class="nav-bg" style="background-image: url('{{asset('public/frontend/assets/images/menu/Capture.PNG') }}')">
                          </div>
                      </div>
                  </li>
                      ...
                      @foreach($category as $row)
                          <li class="nav-btn-box">
                              <a href="{{ url('category/'.$row->id) }}"
                                  ...
                                  <span class="nav-btn__inner" data-text="{{ $row->category_name }}">{{ $row->category_name }}</span>
                              </a>
                          </li>
                          @endforeach
                      </ul>
